...
class Solution(object):
    def diameterOfBinaryTree(self, root):
        ...
        maxDepthLeft = self.findMaxDepth(root.left)
        maxDepthRight = self.findMaxDepth(root.right)
        return max(ansL, ansR, maxDepthLeft + maxDepthLeft + 2)
...
# Comments: The solution above is incorrect and hasn't been figured out. The 2nd
# one is the correct answer but hasn't been figured out either.
